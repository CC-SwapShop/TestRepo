                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            User user = new User(name,email, "https://firebasestorage.googleapis.com/v0/b/swapshop-8094c.appspot.com/o/userImage.png?alt=media&token=a48bffe3-668a-486c-9128-91b3f968c257");
                            //Firebase connection
